...
function input(x) {
    ...
    if (document.getElementById('decimalVar').value == 0) {
        ...
        x += y * 10 //Multiply the text input by ten then add the value of x
...
function decimalPoint() {
    ...
    if(parseInt(document.getElementById('operation').value)) { //if this is an empty string it will retrn false
        document.getElementById('result').value = 0 
    }
